...
const ToastViewport = React.forwardRef(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      // Position toasts at the top-center on all breakpoints
      "fixed top-0 left-1/2 -translate-x-1/2 z-[100] flex max-h-screen w-full sm:w-auto flex-col items-center p-4 md:max-w-[420px]",
      className
    )}
    {...props} />
))
...
const toastVariants = cva(
  // Always slide in from the top for top-anchored toasts
